...
Commentir.prototype = {
  ...
  _getPicURL: function(id, large) {
    return "https://api.twitter.com/1/users/profile_image?screen_name="+(id || this._userid)+"&size=bigger";
  },
 ...
 */
Commentir.prototype.onLoginStateChange = function(onLoginStateChange) {
  var self = this;
 ...
 */
Commentir.prototype.login = function(provider) {
 ...
 */
Commentir.prototype.logout = function() {
  if (this._userid) {
...
Commentir.prototype.onLogin = function(user) {
  ...
  this._fullName = user.displayName;
 ...
 */
Commentir.prototype.onLogout = function() {
  this._user = null;
  this._userid = null;
  this._mainUser = null;
  this._fullName = null;
 ...
 */
Commentir.prototype.getUserInfo = function(user, onComplete,
...
Commentir.prototype.startSearch = function(resultsHandler) {
  this._searchHandler = resultsHandler;
};

Commentir.prototype.updateSearchTerm = function(term) {
  ...
  if (isValidStem(term) && term.length >= 3) {
    if (this._currentSearch) {
      ...
      this._currentSearch = new CommentirSearch(this._firebase, term, this._searchHandler);
    }
  } else {
    this.stopSearching();
  }
...
Commentir.prototype.stopSearching = function() {
  if (this._currentSearch) {
 ...
 */
Commentir.prototype.getSpark = function(id, onComplete) {
  var self = this;
  self._validateCallback(onComplete, true);
 ...
 */
Commentir.prototype.follow = function(user, onComplete) {
  var self = this;
 ...
 */
Commentir.prototype.post = function(content, video, time, onComplete) {
  var self = this;
 ...
 *                                        suggested user.
 */
Commentir.prototype.getSuggestedUsers = function(onSuggestedUser) {
  var self = this;
 ...
 */
Commentir.prototype.setProfileField = function(field, value) {
  var peopleRef = this._firebase.child("people").child(this._userid);
 ...
 * spark (see Commentir.post), which will appear in real-time on the current
 * user's feed!
 *
 ...
 */
Commentir.prototype.onNewSpark = function(totalCount, onComplete, onOverflow) {
 ...
 */
Commentir.prototype.onNewSparkFor = function(id, count, onComplete, onOverflow) {
 ...
 *                                   latest set.
 */
Commentir.prototype.onLatestSpark = function(count, onComplete, onOverflow) {
  this._validateCallback(onComplete, true);
  this._validateCallback(onOverflow, true);
 ...
 * reuse the Commentir object after calling this and registering new handlers.
 */
Commentir.prototype.unload = function() {
